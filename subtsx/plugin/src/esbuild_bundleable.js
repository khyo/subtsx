"use strict";
/// esbuild 0.19.4: search for Kyle Howen to find modifications that made this file capable of being bundled with Electron
...
/*  Kyle Howen, removing this whole section due to require.resolve
...
var ensureServiceIsRunning = () => {
  ...
  // Kyle Howen: start changes
  // use process.env to communicate ESBuild location
  // let [command, args] = esbuildCommandAndArgs();
  let command = process.env.ESBUILD_BINARY_PATH;
  let args = [];
  // Kyle Howen: end changes
